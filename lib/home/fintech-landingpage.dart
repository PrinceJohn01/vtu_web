              ...
              children: [
                Container(
                  padding: EdgeInsets.fromLTRB(
                      110 * fem, 25 * fem, 110 * fem, 163 * fem),
                  width: double.infinity,
                  child: Column(
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      Container(
                        ...
                        child: Row(
                          ...
                          children: [
                            Container(
                              margin: EdgeInsets.fromLTRB(
                                  0 * fem, 0 * fem, 333.5 * fem, 24.74 * fem),
                              height: 45.26 * fem,
                              child: Row(
                                crossAxisAlignment: CrossAxisAlignment.center,
                                children: [
